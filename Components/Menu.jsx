      ...
      const Menu = () => {
        ...
        useEffect(() => {
          ...
          const fetchPriorities = async () => {
            setIsLoading(prev => ({ ...prev, priorities: true }));
            setError(prev => ({ ...prev, priorities: null }));
            try {
              const response = await fetch(
              ...
              setError(prev => ({ ...prev, priorities: err.message }));
              console.error("Error fetching priorities:", err);
            } finally {
              setIsLoading(prev => ({ ...prev, priorities: false }));
            }
          };
